...
/* 5 */int stimuliArray[] = {0,5,3,1,3,2,1,2,2,1,0,2,4,5,4,5,4,0,5,5,0,3,5,5,2,5,4,0,3,1,4,2,1,3,4,0,3,1,3,4,0,3,4,3,0,4,1,4,0,2,1,2,5,0,5,2,3,1,2,0,1,2,5,3,5,5,9};
